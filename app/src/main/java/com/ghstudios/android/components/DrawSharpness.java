...
public class DrawSharpness extends View {
    ...
    private final int maxsharpness = 100;
    ...
    public static int cyanColor = Color.rgb(0,255,255);
    ...
    public DrawSharpness(Context context, AttributeSet attrs){
        ...
        if (isInEditMode()) {
            init(new int[] {6,5,11,9,4,0,0,0,0},
                    new int[] {6,5,11,9,6,0,0,0,0},
                    new int[]{ 6,5,11,9,6,3,0,0,0});
        }
    }
	...
	public void onDraw(Canvas canvas) {
        ...
        drawBar(canvas, outer_margin, scalefactor, bartop, barbottom,
                mRed1, mOrange1, mYellow1, mGreen1, mBlue1, mWhite1, mPurple1, mCyan1);
        ...
        drawBar(canvas, outer_margin, scalefactor, bartop2, barbottom2,
                mRed2, mOrange2, mYellow2, mGreen2, mBlue2, mWhite2, mPurple2, mCyan2);
        ...
        drawBar(canvas, outer_margin, scalefactor, bartop3, barbottom3,
                mRed3, mOrange3, mYellow3, mGreen3, mBlue3, mWhite3, mPurple3, mCyan3);
    ...
    private void drawBar(Canvas canvas, int margins, float scalefactor, int bartop, int barbottom,
                         ...
                         int igreen, int iblue, int iwhite, int ipurple, int icyan){
