...
public class DecorationCursor extends CursorWrapper {
	...
	public Decoration getDecoration() {
		...
		long skill_3_id = getLong(getColumnIndex("skill_3_id"));
		String skill_3_name = getString(getColumnIndex("skill_3_name"));
		int skill_3_point = getInt(getColumnIndex("skill_3_point_value"));

		long skill_4_id = getLong(getColumnIndex("skill_4_id"));
		String skill_4_name = getString(getColumnIndex("skill_4_name"));
		int skill_4_point = getInt(getColumnIndex("skill_4_point_value"));
		...
		decoration.setSkill3Id(skill_3_id);
		decoration.setSkill3Name(skill_3_name);
		decoration.setSkill3Point(skill_3_point);

		decoration.setSkill4Id(skill_4_id);
		decoration.setSkill4Name(skill_4_name);
		decoration.setSkill4Point(skill_4_point);
