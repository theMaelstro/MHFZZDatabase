...
class HuntingRewardsDao(val dbMainHelper: SQLiteOpenHelper) {
    ...
    private val column_condition get() = localizeColumn("h.condition")

    private val reward_columns
        get() = "h._id, h.monster_id, h.item_id, $column_condition condition, h.rank, h.stack_size, h.percentage, " +
