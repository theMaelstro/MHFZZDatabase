    ...
    val gathering: Gathering
        get() {
            val gathering = Gathering().apply {
                ...
                season = if(hasColumn(S.COLUMN_GATHERING_SEASON)) getString(S.COLUMN_GATHERING_SEASON) else null
                time = if(hasColumn(S.COLUMN_GATHERING_TIME)) getString(S.COLUMN_GATHERING_TIME) else null
