...
public class S {
	...
	public static final String TABLE_ARMOR_UPGRADE = "armor_upgrade";
	public static final String COLUMN_ARMOR_UPGRADE_ID = "_id";
	public static final String COLUMN_ARMOR_UPGRADE_TYPE_ID = "descendant_type";
	public static final String COLUMN_ARMOR_UPGRADE_ITEM_ID = "item_id";
	public static final String COLUMN_ARMOR_UPGRADE_DESCENDANT_ID = "descendant_id";


	// Bento
	public static final String TABLE_BENTO = "bento";
	public static final String COLUMN_BENTO_ID = "_id";
	public static final String COLUMN_BENTO_NAME = "name";
	public static final String COLUMN_BENTO_EFFECT_1 = "effect1";
	public static final String COLUMN_BENTO_EFFECT_2 = "effect2";
	public static final String COLUMN_BENTO_EFFECT_3 = "effect3";
	public static final String COLUMN_BENTO_EFFECT_4 = "effect4";
	public static final String COLUMN_BENTO_INGREDIENT_1_ID = "ingredient1_id";
	public static final String COLUMN_BENTO_INGREDIENT_2_ID = "ingredient2_id";
	//public static final String COLUMN_BENTO_ICON = "icon_name";

	// Shop List
	public static final String TABLE_SHOP_LIST = "shop_list";
	public static final String COLUMN_SHOP_LIST_ITEM_ID = "item_id";
	public static final String COLUMN_SHOP_LIST_COST = "cost";
	public static final String COLUMN_SHOP_LIST_STORE = "store";
	public static final String COLUMN_SHOP_LIST_QUANTITY = "quantity";
	public static final String COLUMN_SHOP_LIST_NOTES = "notes";
	...
	public static final String COLUMN_COMBINING_ITEM_3_ID = "item_3_id";
	...
	public static final String COLUMN_GATHERING_SEASON = "season";
	public static final String COLUMN_GATHERING_TIME = "time";
	...
	public static final String COLUMN_ITEMS_ITEM_HID = "item_hid";
	...
	public static final String COLUMN_MONSTERS_CLASS_TYPE = "monster_class";
	public static final String COLUMN_MONSTERS_SIZE_MIN = "monster_size_min";
	public static final String COLUMN_MONSTERS_SIZE_MAX = "monster_size_max";
    ...
    public static final String COLUMN_QUESTS_SUB_A_GOAL = "sub_goal_a";
    public static final String COLUMN_QUESTS_SUB_A_REWARD = "sub_reward_a";
    public static final String COLUMN_QUESTS_SUB_A_HRP = "sub_hrp_a";
	public static final String COLUMN_QUESTS_SUB_B_GOAL = "sub_goal_b";
	public static final String COLUMN_QUESTS_SUB_B_REWARD = "sub_reward_b";
	public static final String COLUMN_QUESTS_SUB_B_HRP = "sub_hrp_b";
	public static final String COLUMN_QUESTS_HIRER = "hirer";
	...
	public static final String COLUMN_WEAPONS_REACH = "reach";
