...
class WeaponBowgunDetailViewHolder(parent: ViewGroup): WeaponDetailViewHolder {
    ...
    init {
        ...
        ammoCells = listOf(
            ...
            view.findViewById(R.id.tranq),
            view.findViewById(R.id.apaint),
            view.findViewById(R.id.demon),
            view.findViewById(R.id.armor)
        )
/*
 ...
 */
    ...
    private fun bindRapidFire(weapon: Weapon) {
        ...
        for ((ammoView, rapidValue) in extraAmmoCells.zip(rapid)) {
            ...
            */
            ...
            context.getString(R.string.weapon_rapid_row, rapidValue).also { ammoView.text = it }
            ammoView.visibility = View.VISIBLE
        }
    }
    ...
    private fun bindSiegeFire(weapon: Weapon) {
        ...
        */
        view.weapon_extra_title.visibility = View.INVISIBLE
