...
class ArmorSetSummaryFragment : Fragment() {
    ...
    private fun populateArmor(armorPoints: List<ArmorSkillPoints>?){
        ...
        fireResTextView.text = armors.sumOf{ it.fireRes }.toString()
        waterResTextView.text = armors.sumOf{ it.waterRes }.toString()
        iceResTextView.text = armors.sumOf{ it.iceRes }.toString()
        thunderResTextView.text = armors.sumOf{ it.thunderRes }.toString()
        dragonResTextView.text = armors.sumOf{ it.dragonRes }.toString()
