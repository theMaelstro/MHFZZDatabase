...
class QuestDetailFragment : Fragment() {
    ...
    private fun updateUI(mQuest: Quest) {
        ...
        subquest_a.text = mQuest.subGoalA
        subhrp_a.text = "${mQuest.subHrpA}"
        subreward_a.text = "${mQuest.subRewardA}z"

        subquest_b.text = mQuest.subGoalB
        subhrp_b.text = "${mQuest.subHrpB}"
        subreward_b.text = "${mQuest.subRewardB}z"

        hirer.text = mQuest.hirer
