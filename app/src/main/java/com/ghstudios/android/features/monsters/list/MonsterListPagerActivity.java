...
public class MonsterListPagerActivity extends BasePagerActivity {
    ...
    public void onAddTabs(TabAdder tabs) {
        ...
        tabs.addTab(R.string.monster_class_extreme, () ->
                MonsterListFragment.newInstance(MonsterClass.EXTREME)
        );
        ...
        tabs.addTab(R.string.monster_class_type, () ->
                MonsterExpendableListFragment.newInstance("Type")
        );
